...
function NavigationMenuTrigger({
  ...
  return (
    ...
    >
      <ChevronDownIcon
        className="relative top-px mr-1 size-3 transition duration-300 group-data-popup-open/navigation-menu-trigger:rotate-180 group-data-open/navigation-menu-trigger:rotate-180"
        aria-hidden="true"
      />{" "}
      {children}
    </NavigationMenuPrimitive.Trigger>
