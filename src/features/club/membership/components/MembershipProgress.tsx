  ...
  return (
    <Container>
      <div className="grid w-full gap-3">
        <div className="grid w-full lg:grid-cols-[1fr_320px] items-center max-w-6xl mx-auto gap-8">
          <div className="flex flex-col gap-4">
            <ProgressCard current={124} max={400} />
          </div>

          <div className="rounded-full flex h-max flex-col gap-2 items-center justify-center border bg-requirement/10 backdrop-blur-[3px] py-8 px-10 text-center border-r-background border-l-background">
        ...
        <div className="flex flex-wrap justify-center gap-3 bg-background w-full mx-auto px-2 lg:px-6 py-1.5 rounded-xl">
